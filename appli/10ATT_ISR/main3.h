...
#define ISRPRI_CMI1		1						// 割込みサービスルーチン優先度：1(高)～7(低)
#define INTATR_CMI1		(TA_NULL)		// 割込み属性：割込み有効、立ち上がりエッジ
...
extern void disp_task(intptr_t exinf);
extern void cmi1_interrupt(intptr_t exinf);
