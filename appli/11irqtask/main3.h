...
#define INHNO_IRQ3		INT_IRQ3			// 割込みハンドラ番号：67
#define INTNO_IRQ3		INT_IRQ3			// 割込み番号：67
#define INTPRI_IRQ		-4					// 割込み優先度：-1(低)～-7(高)
#define ISRPRI_IRQ		1					// 割込みサービスルーチン優先度：1(低)～7(高)
...
extern void irqsw_task(intptr_t exinf);
extern void irq2_interrupt(intptr_t exinf);
extern void irq3_interrupt(intptr_t exinf);
