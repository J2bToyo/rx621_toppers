 ...
 *	メンバでなくTCB構造体のメンバであるTSKCTXB構造体のメンバで
...
const TCB	____BEGIN_OFF_TCB_tstat = {
		{ NULL, NULL }, NULL , 1, 0,
		0, 0 , 0 , 0 , NULL , { NULL , NULL }
	};

const TCB	____BEGIN_OFF_TCB_tinib = {
		{ NULL, NULL }, (TINIB *)1 , 0 , 0,
		0, 0 , 0 , 0 , NULL , { NULL , NULL }
	};

const TCB	____BEGIN_OFF_TCB_pc = {
		{ NULL, NULL }, NULL, 0, 0,
		0, 0 , 0 , 0 , NULL , { NULL , (FP)1 }
	};
const TCB	____BEGIN_OFF_TCB_sp = {
		{ NULL, NULL }, NULL, 0, 0,
		0, 0 , 0 , 0 , NULL , { (void *)1 , NULL }
	};

const TCB	____BEGIN_BIT_TCB_enatex = {
		{ NULL, NULL }, NULL, 0, 0,
		0, 0 , 1 , 0 , NULL , { NULL , NULL }
	};

const TCB	____BEGIN_OFF_TCB_texptn = {
		{ NULL, NULL }, NULL, 0, 0,
		0 , 0 , 0 , 1 , NULL , { NULL , NULL }
	};

const TINIB	____BEGIN_OFF_TINIB_exinf = {
		0 , (intptr_t)1 , NULL , 0 , 0 , NULL , 0 , NULL
	};

const TINIB	____BEGIN_OFF_TINIB_task = {
