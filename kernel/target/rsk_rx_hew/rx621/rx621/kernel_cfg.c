...
INTHDR_ENTRY(235, 235, _kernel_inthdr_235)
INTHDR_ENTRY(237, 237, _kernel_inthdr_237)

const INHINIB _kernel_inhinib_table[TNUM_INHNO] = {
	{ (INHNO_TIMER), (TA_NULL), (FP)(INT_ENTRY(INHNO_TIMER, target_timer_handler)) },
	{ (235), (TA_NULL), (FP)(INT_ENTRY(235, _kernel_inthdr_235)) },
	{ (237), (TA_NULL), (FP)(INT_ENTRY(237, _kernel_inthdr_237)) }
};
