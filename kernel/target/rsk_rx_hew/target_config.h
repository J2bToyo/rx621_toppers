 ...
 */
/////////////////////////////////////////////////////////////////////////////////////////
// START 2020.10.1【修正】RX610のSCI1(2?)からRX621のSCI5(5)を使用することへの対応
/////////////////////////////////////////////////////////////////////////////////////////

#define TARGET_PUTC_PORTID	( 5 )
//#define TARGET_PUTC_PORTID	( 2 )

/////////////////////////////////////////////////////////////////////////////////////////
// END 2020.10.1【修正】RX610のSCI1(2?)からRX621のSCI5(5)を使用することへの対応
/////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
// START 2020.10.1【修正】ヘッダファイル読み込み部のRX610からRX621への対応
/////////////////////////////////////////////////////////////////////////////////////////
/*
 *  プロセッサ依存モジュール（RX610用）
 */
//#include "rx_rxc/rx610_config.h"
#include "rx_rxc/rx621_config.h"

/////////////////////////////////////////////////////////////////////////////////////////
// END 2020.10.1【修正】ヘッダファイル読み込み部のRX610からRX621への対応
/////////////////////////////////////////////////////////////////////////////////////////
