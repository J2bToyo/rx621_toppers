...
#define INHNO_SIO_TX	INT_SCI5_TEI5			/* 割込みハンドラ番号 */
#define INTNO_SIO_TX	INT_SCI5_TEI5			/* 割込み番号 */
#define INHNO_SIO_RX	INT_SCI5_RXI5			/* 割込みハンドラ番号 */
#define INTNO_SIO_RX	INT_SCI5_RXI5			/* 割込み番号 */
#define INTPRI_SIO		-4						/* 割込み優先度 */
#define INTATR_SIO		(TA_NULL)				/* 割込み属性 */
